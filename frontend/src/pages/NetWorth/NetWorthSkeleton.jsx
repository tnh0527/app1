...
/**
 * NetWorth Skeleton - Custom skeleton layout matching NetWorth dashboard
 */
export const NetWorthSkeleton = () => {
  return (
    <div className="networth-page">
      {/* Header Skeleton */}
      <div className="networth-header skeleton-header">
        <div className="header-title">
          <SkeletonElement type="title" width="220px" height="28px" />
          <SkeletonElement type="text" width="180px" />
        </div>
        <div className="header-actions">
          <SkeletonElement type="badge" width="120px" height="40px" style={{ borderRadius: "10px" }} />
          <SkeletonElement type="badge" width="120px" height="40px" style={{ borderRadius: "10px" }} />
