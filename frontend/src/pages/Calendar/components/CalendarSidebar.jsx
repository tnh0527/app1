  ...
  return (
    <div className="calendar-sidebar">
      ...
      <div className="sidebar-panel sidebar-panel--analytics">
        ...
        <div className="panel-content">
          <div className="this-month-summary">
            <div className="summary-row summary-row--today">
              <span className="summary-label summary-label--today">Today</span>
              <span className="summary-value">{stats.todayCount}</span>
            </div>
            <div className="summary-row">
              <span className="summary-label">This Month</span>
              <span className="summary-value">{stats.totalThisMonth}</span>
            </div>
            <div className="summary-row">
              <span className="summary-label">Recurring</span>
              <span className="summary-value">{stats.recurringCount}</span>
            </div>
            {stats.busiestDay && (
              <div className="summary-row busiest-row">
                <span className="summary-label">Busiest Day</span>
                <div className="summary-value stat-value--small">
