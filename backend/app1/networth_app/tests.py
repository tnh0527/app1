...
from .services import NetWorthService, CashFlowService
...
class NetWorthServiceTests(TestCase):
    ...
    def setUp(self):
        ...
        self.service = NetWorthService(self.user)
    ...
    def test_create_networth_snapshot(self):
        """Test creating net worth snapshot."""
        snapshot = self.service.create_networth_snapshot()
    ...
    def test_snapshot_idempotency(self):
        ...
        snapshot1 = self.service.create_networth_snapshot()
        snapshot2 = self.service.create_networth_snapshot()
...
class NetWorthAPITests(APITestCase):
    ...
    def test_create_account(self):
        ...
        response = self.client.post('/api/networth/accounts/', data)
    ...
    def test_list_accounts(self):
        ...
        response = self.client.get('/api/networth/accounts/')
    ...
    def test_dashboard_summary(self):
        ...
        response = self.client.get('/api/networth/dashboard/summary/')
    ...
    def test_full_dashboard(self):
        ...
        response = self.client.get('/api/networth/dashboard/')
