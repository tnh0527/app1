    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('account', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='cashflow_entries', to='financials_app.financialaccount')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('account', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='snapshots', to='financials_app.financialaccount')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('accounts', models.ManyToManyField(blank=True, related_name='groups', to='financials_app.financialaccount')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('created_at', models.DateTimeField(auto_now_add=True)),
                ('updated_at', models.DateTimeField(auto_now=True)),
                ('linked_account', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='milestones', to='financials_app.financialaccount')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('payment_account', models.ForeignKey(blank=True, help_text='Account used to pay this subscription', null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='subscriptions_paid', to='financials_app.financialaccount')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('related_account', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='changes', to='financials_app.financialaccount')),
                ('related_milestone', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='changes', to='financials_app.FinancialsMilestone')),
                ('snapshot_from', models.ForeignKey(blank=True, help_text='Previous snapshot', null=True, on_delete=django.db.models.deletion.CASCADE, related_name='changes_from', to='financials_app.FinancialsSnapshot')),
                ('snapshot_to', models.ForeignKey(help_text='Current snapshot', on_delete=django.db.models.deletion.CASCADE, related_name='changes_to', to='financials_app.FinancialsSnapshot')),
                ('related_subscription', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='changes', to='financials_app.subscription')),
            ],
            options={
        ...
        migrations.RunSQL(
            sql="CREATE INDEX IF NOT EXISTS networth_ap_owner_i_466179_idx ON networth_app_financialaccount (owner_id, account_type);",
            reverse_sql="DROP INDEX IF EXISTS networth_ap_owner_i_466179_idx;",
        ),
        migrations.RunSQL(
            sql="CREATE INDEX IF NOT EXISTS networth_ap_owner_i_48da52_idx ON networth_app_financialaccount (owner_id, is_active);",
            reverse_sql="DROP INDEX IF EXISTS networth_ap_owner_i_48da52_idx;",
        ),
        migrations.RunSQL(
            sql="CREATE INDEX IF NOT EXISTS networth_ap_owner_i_6ab814_idx ON networth_app_financialaccount (owner_id, created_at);",
            reverse_sql="DROP INDEX IF EXISTS networth_ap_owner_i_6ab814_idx;",
        ),
        migrations.RunSQL(
            sql="""
                DO $$
                BEGIN
                    IF NOT EXISTS (
                        ...
                        ALTER TABLE networth_app_financialaccount 
                        ADD CONSTRAINT uniq_account_owner_name 
                        UNIQUE (owner_id, name);
                    END IF;
                END $$;
            """,
            reverse_sql="ALTER TABLE networth_app_financialaccount DROP CONSTRAINT IF EXISTS uniq_account_owner_name;",
        ),
        migrations.RunSQL(
            sql="CREATE INDEX IF NOT EXISTS networth_ap_owner_i_2b7aff_idx ON networth_app_cashflowentry (owner_id, entry_date);",
            reverse_sql="DROP INDEX IF EXISTS networth_ap_owner_i_2b7aff_idx;",
        ),
        migrations.RunSQL(
            sql="CREATE INDEX IF NOT EXISTS networth_ap_owner_i_11b625_idx ON networth_app_cashflowentry (owner_id, entry_type, entry_date);",
            reverse_sql="DROP INDEX IF EXISTS networth_ap_owner_i_11b625_idx;",
        ),
        migrations.RunSQL(
            sql="CREATE INDEX IF NOT EXISTS networth_ap_owner_i_7186a9_idx ON networth_app_cashflowentry (owner_id, category);",
            reverse_sql="DROP INDEX IF EXISTS networth_ap_owner_i_7186a9_idx;",
        ),
        migrations.RunSQL(
            sql="CREATE INDEX IF NOT EXISTS networth_ap_account_5b69f2_idx ON networth_app_accountsnapshot (account_id, recorded_at);",
            reverse_sql="DROP INDEX IF EXISTS networth_ap_account_5b69f2_idx;",
        ),
        migrations.RunSQL(
            sql="CREATE INDEX IF NOT EXISTS networth_ap_recorde_b3271f_idx ON networth_app_accountsnapshot (recorded_at);",
            reverse_sql="DROP INDEX IF EXISTS networth_ap_recorde_b3271f_idx;",
        ),
        migrations.RunSQL(
            sql="CREATE INDEX IF NOT EXISTS networth_ap_created_1f2b28_idx ON networth_app_accountsnapshot (created_at);",
            reverse_sql="DROP INDEX IF EXISTS networth_ap_created_1f2b28_idx;",
        ),
        migrations.RunSQL(
            sql="""
                DO $$
                BEGIN
                    IF NOT EXISTS (
                        ...
                        ALTER TABLE networth_app_accountsnapshot 
                        ADD CONSTRAINT uniq_snapshot_account_date 
                        UNIQUE (account_id, recorded_at);
                    END IF;
                END $$;
            """,
            reverse_sql="ALTER TABLE networth_app_accountsnapshot DROP CONSTRAINT IF EXISTS uniq_snapshot_account_date;",
        ),
        migrations.RunSQL(
            sql="""
                DO $$
                BEGIN
                    IF NOT EXISTS (
                        ...
                        ALTER TABLE networth_app_accountgroup 
                        ADD CONSTRAINT uniq_group_owner_name 
                        UNIQUE (owner_id, name);
                    END IF;
                END $$;
            """,
            reverse_sql="ALTER TABLE networth_app_accountgroup DROP CONSTRAINT IF EXISTS uniq_group_owner_name;",
        ),
        migrations.RunSQL(
            sql="CREATE INDEX IF NOT EXISTS networth_ap_owner_i_f52012_idx ON networth_app_networthmilestone (owner_id, is_active);",
            reverse_sql="DROP INDEX IF EXISTS networth_ap_owner_i_f52012_idx;",
        ),
        migrations.RunSQL(
            sql="CREATE INDEX IF NOT EXISTS networth_ap_owner_i_854694_idx ON networth_app_networthmilestone (owner_id, achieved_at);",
            reverse_sql="DROP INDEX IF EXISTS networth_ap_owner_i_854694_idx;",
        ),
        migrations.RunSQL(
            sql="CREATE INDEX IF NOT EXISTS networth_ap_owner_i_22b0a0_idx ON networth_app_networthsnapshot (owner_id, recorded_at);",
            reverse_sql="DROP INDEX IF EXISTS networth_ap_owner_i_22b0a0_idx;",
        ),
        migrations.RunSQL(
            sql="""
                DO $$
                BEGIN
                    IF NOT EXISTS (
                        ...
                        ALTER TABLE networth_app_networthsnapshot 
                        ADD CONSTRAINT uniq_networth_owner_date 
                        UNIQUE (owner_id, recorded_at);
                    END IF;
                END $$;
            """,
            reverse_sql="ALTER TABLE networth_app_networthsnapshot DROP CONSTRAINT IF EXISTS uniq_networth_owner_date;",
        ),
        migrations.RunSQL(
            sql="""
                DO $$
                BEGIN
                    IF EXISTS (SELECT 1 FROM information_schema.tables WHERE table_name = 'networth_app_subscription') THEN
                        CREATE INDEX IF NOT EXISTS networth_ap_owner_i_0a671c_idx ON networth_app_subscription (owner_id, is_active);
                        CREATE INDEX IF NOT EXISTS networth_ap_owner_i_c2eaf1_idx ON networth_app_subscription (owner_id, next_billing_date);
                        CREATE INDEX IF NOT EXISTS networth_ap_categor_88cd40_idx ON networth_app_subscription (category);
                    END IF;
                END $$;
            """,
            reverse_sql="DROP INDEX IF EXISTS networth_ap_owner_i_0a671c_idx, networth_ap_owner_i_c2eaf1_idx, networth_ap_categor_88cd40_idx;",
        ),
        migrations.RunSQL(
            sql="CREATE INDEX IF NOT EXISTS networth_ap_owner_i_b2ecc6_idx ON networth_app_changelog (owner_id, created_at);",
            reverse_sql="DROP INDEX IF EXISTS networth_ap_owner_i_b2ecc6_idx;",
        ),
        migrations.RunSQL(
            sql="CREATE INDEX IF NOT EXISTS networth_ap_owner_i_d34b8e_idx ON networth_app_changelog (owner_id, change_type);",
            reverse_sql="DROP INDEX IF EXISTS networth_ap_owner_i_d34b8e_idx;",
        ),
        migrations.RunSQL(
            sql="CREATE INDEX IF NOT EXISTS networth_ap_snapsho_c7d8d2_idx ON networth_app_changelog (snapshot_to_id);",
            reverse_sql="DROP INDEX IF EXISTS networth_ap_snapsho_c7d8d2_idx;",
        ),
    ]
