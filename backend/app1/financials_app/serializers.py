"""
Financials Dashboard Serializers
...
class FinancialsSnapshotSerializer(serializers.ModelSerializer):
    """Serializer for FinancialsSnapshot model."""
...
class FinancialsMilestoneSerializer(serializers.ModelSerializer):
    """Serializer for FinancialsMilestone model."""
    
    is_achieved = serializers.BooleanField(read_only=True)
    
    class Meta:
        model = FinancialsMilestone
        fields = [
