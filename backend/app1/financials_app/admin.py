...
@admin.register(FinancialsSnapshot)
class FinancialsSnapshotAdmin(admin.ModelAdmin):
    list_display = [
...
@admin.register(FinancialsMilestone)
class FinancialsMilestoneAdmin(admin.ModelAdmin):
    list_display = [
